		...
		<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
			<div class="navbar-brand-wrapper d-flex align-items-center">
				<a class="navbar-brand" href="<?= base_url(); ?>">
					<h3 class="text-light">JASA RAHARJA</h3>
				</a>
			</div>
					...
					<?php if ($profileKeisi > 0) : ?>
						<li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
							<a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
								<img class="img-xs rounded-circle ml-2" src="<?= base_url(); ?>vendor/Stellar/images/faces/faceavatar.jpg" alt="Profile image"> <span class="font-weight-normal"> <?= $user['nama']; ?> </span></a>
							<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
								<div class="dropdown-header text-center">
									<img class="img-md rounded-circle" src="<?= base_url(); ?>vendor/Stellar/images/faces/faceavatar.jpg" style="width: 40%;" alt="Profile image">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="menu-cuti">
								<ul class="nav flex-column sub-menu">
									...
									<?php
									// Tambahkan pengecekan level sebelum menampilkan opsi "Pengajuan Cuti"
